    ...
    <div className="bg-gray-100 min-h-screen p-6">
      ...
      <div className="bg-white rounded-lg shadow overflow-x-auto">
        <table className="min-w-full leading-normal m-5">
          <thead>
            <tr>
              <th className="px-4 py-3 border-b-2 border-gray-200 bg-gray-50 text-left text-sm font-semibold text-gray-600">
                Product Name
              </th>
              <th className="px-4 py-3 border-b-2 border-gray-200 bg-gray-50 text-left text-sm font-semibold text-gray-600">
                Category
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="flex items-center space-x-2">
          <button className="bg-gray-200 text-gray-600 py-1 px-3 rounded-lg hover:bg-gray-300">
            Prev
          </button>
